var CONFIG = {
				COURSETITLE			: "501 Form: Termination Reason",
				FILENAME			: "501 Form_Termination Reason_html5.swf",
				BGCOLOR				: "#ffffff",
				FPVERSION			: "10",
				COURSE_WIDTH		: "910",
				COURSE_HEIGHT		: "570",
...
function DoFinish()
{
	...
	*/
    ...
    lRunningInConnectFunctionExists = window.parent && window.parent.IsRunningInConnect && typeof window.parent.IsRunningInConnect === 'function' ;
    lRunningInConnect =  lRunningInConnectFunctionExists && window.parent.IsRunningInConnect() ;
