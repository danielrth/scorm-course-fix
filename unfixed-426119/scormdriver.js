...
WriteToDebug("SCORM2004_objAPI="+typeof(SCORM2004_objAPI));InitializeExecuted(false,"This file was configured to be viewed in a LMS.Upload and launch this file in a LMS to view the content.");return false;}
...
function SCORM_Initialize(){var blnResult=true;WriteToDebug("In SCORM_Initialize");SCORM_ClearErrorInfo();WriteToDebug("Grabbing API");try{SCORM_objAPI=SCORM_GrabAPI();}
catch(e){WriteToDebug("Error grabbing 1.2 API-"+e.name+":"+e.message);}
...
blnResult=SCORM_CallLMSSetValue("cmi.success_status",'passed')&&blnResult;
blnResult=SCORM_CallLMSSetValue("cmi.completion_status",'completed')&&blnResult;
...
function SCORM_CallLMSInitialize(){var strResult;WriteToDebug("In SCORM_CallLMSInitialize");
SCORM_objAPI=SCORM_GrabAPI();WriteToDebug("Calling LMSInitialize");strResult=SCORM_objAPI.LMSInitialize("");strResult=strResult+"";
...
winDebug=window.open("","Debug","width=600,height=300,resizable,scrollbars");winDebug.document.write(aryDebug.join("<br>\n"));winDebug.document.close();winDebug.focus();return;}
