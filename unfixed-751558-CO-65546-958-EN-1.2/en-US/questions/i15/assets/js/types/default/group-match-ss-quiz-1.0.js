...
function handleCardDrop(event, ui) {
    ...
    /*Disable droppable when more than 4 draggables are present. Enable it when less than 4 are present*/
    var boxCount = $(this).children().length;
    //console.log("Box " + $(this).attr('id') + " contains: " + boxCount + " items.");
    if (boxCount >= 3) {
